...
helloWorldMessage1.setGreetingMessage("hello charitha1");

HelloWorldMessage helloWorldMessage2 = ctxt.getBean(HelloWorldMessage.class);
helloWorldMessage2.setGreetingMessage("hello charitha2");
...
## 4. @Scope("prototype")
Used to make Spring return a **new instance** every time a bean is requested.
