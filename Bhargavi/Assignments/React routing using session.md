...
function App() {
  const [books, setBooks] = useState([
    ...
    { id: 3, title: "The Fall of Numenor", author: "J.R.R. Tolkien", price: 20 }
  ]);
...
function SessionStorage() {
    useEffect(() => {
        const persons = [
            { "id": '1', "name": "raju", "age": 20, "address": "BTM" },
            { "id": '2', "name": "ravi", "age": 25, "address": "BTM" },
            { "id": '3', "name": "ramu", "age": 30, "address": "JP Nagar" }
        ]
...
3    The Fall of Numenor  J.R.R. Tolkien   20    Read   Update   Delete
4    Bhargavi             Bhargavi         500   Read   Update   Delete
