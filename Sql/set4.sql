...
student_name VARCHAR(100) NOT NULL, class_id INT,
...
INSERT INTO students (student_name, class_id) VALUES ('Alice', 1),
('Bob', 2),
('Charlie', 1);
...
referenced_table_name IS NOT NULL AND table_schema = 'school';
