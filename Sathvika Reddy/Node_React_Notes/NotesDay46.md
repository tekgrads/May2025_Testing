...
* `index.html` demonstrates basic DOM manipulation using JavaScript.
* `App.js`, `App2.js`, `App3.js` showcase JavaScript variable scope with `var`, `let`, and `const` inside a React component.
* `index.js` renders components (`App`, `App2`, `App3`) into the React DOM root.
* `App.css` and `index.css` define styles for components and global styles.
* `reportWebVitals.js` is used to measure app performance metrics.
